...
if __name__ == "__main__":
    ...
    #error_results = avg_train_test(np.array(state_norm.array), laplacian = state_L, test_list = [0.05, 0.1, 0.2], runs = 10, 
    ...
    np.savetxt("hoyer_parameter_results.csv", reshaped_error, delimiter = ',')
    f = open("hoyer_error_shape.txt", "w+")
